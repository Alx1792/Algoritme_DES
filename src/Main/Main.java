    ...
    public static void encriptar() {
        ...
        for (int i = 0; i < nChunksText; i++) {
            if (i == nChunksText - 1) {
                ...
                System.out.println(String.format("Chunck n%s = %s", i + 1, binari1.substring(ultimaP, ultimaP + 64)));
                chunksText.add(omplirText(binari1.substring(ultimaP, ultimaP + 64)));
                ultimaP = ultimaP + 64;
            }
        }

        System.out.println("Introdueix contrasenya a encriptar");
        ...
        for (String chunk : chunksText) {
            ...
            System.out.println("Resultat del chunk " + textFin);
        ...
        public static String combinarCHunks(ArrayList<String> chunks) {
            String resultat = "";
            for (String chunk : chunks) {
                resultat = resultat + chunk;
            }
            return resultat;
        }
